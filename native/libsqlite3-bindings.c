...
struct drb_foreign_object_ZTSPFvPPviE {
    drb_foreign_object_kind kind;
    void (*value)(void **, int);
    int should_free;
};
static mrb_data_type ForeignObjectType_ZTSPFvPPviE = {"Function_17*", drb_free_foreign_object_indirect};
static void (*drb_ffi__ZTSPFvPPviE_FromRuby(mrb_state *state, mrb_value self))(void **, int) {
    if (mrb_nil_p(self))
        return 0;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Function_17Pointer");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTSPFvPPviE);
    return ((struct drb_foreign_object_ZTSPFvPPviE *)DATA_PTR(self))->value;
}
static mrb_value drb_ffi__ZTSPFvPPviE_ToRuby(mrb_state *state, void (*value)(void **, int)) {
    struct drb_foreign_object_ZTSPFvPPviE *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTSPFvPPviE));
    ptr->value = value;
    ptr->kind = drb_foreign_object_kind_pointer;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Function_17Pointer");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTSPFvPPviE);
    return mrb_obj_value(rdata);
}
...
static mrb_data_type ForeignObjectType_ZTSPFiPvP7sqlite3PKciE = {"Function_18*", drb_free_foreign_object_indirect};
...
struct drb_foreign_object_ZTSPP16sqlite3_snapshot {
    drb_foreign_object_kind kind;
    sqlite3_snapshot **value;
    int should_free;
};
static mrb_data_type ForeignObjectType_ZTSPP16sqlite3_snapshot = {"sqlite3_snapshot**", drb_free_foreign_object_indirect};
static sqlite3_snapshot **drb_ffi__ZTSPP16sqlite3_snapshot_FromRuby(mrb_state *state, mrb_value self) {
    if (mrb_nil_p(self))
        return 0;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Sqlite3_snapshotPointerPointer");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTSPP16sqlite3_snapshot);
    return ((struct drb_foreign_object_ZTSPP16sqlite3_snapshot *)DATA_PTR(self))->value;
}
static mrb_value drb_ffi__ZTSPP16sqlite3_snapshot_ToRuby(mrb_state *state, sqlite3_snapshot **value) {
    struct drb_foreign_object_ZTSPP16sqlite3_snapshot *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTSPP16sqlite3_snapshot));
    ptr->value = value;
    ptr->kind = drb_foreign_object_kind_pointer;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Sqlite3_snapshotPointerPointer");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTSPP16sqlite3_snapshot);
    return mrb_obj_value(rdata);
}
struct drb_foreign_object_ZTSP16sqlite3_snapshot {
    drb_foreign_object_kind kind;
    sqlite3_snapshot *value;
    int should_free;
};
static mrb_data_type ForeignObjectType_ZTSP16sqlite3_snapshot = {"sqlite3_snapshot*", drb_free_foreign_object_indirect};
static sqlite3_snapshot *drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(mrb_state *state, mrb_value self) {
    if (mrb_nil_p(self))
        return 0;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Sqlite3_snapshotPointer");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTSP16sqlite3_snapshot);
    return ((struct drb_foreign_object_ZTSP16sqlite3_snapshot *)DATA_PTR(self))->value;
}
static mrb_value drb_ffi__ZTSP16sqlite3_snapshot_ToRuby(mrb_state *state, sqlite3_snapshot *value) {
    struct drb_foreign_object_ZTSP16sqlite3_snapshot *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTSP16sqlite3_snapshot));
    ptr->value = value;
    ptr->kind = drb_foreign_object_kind_pointer;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Sqlite3_snapshotPointer");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTSP16sqlite3_snapshot);
    return mrb_obj_value(rdata);
}
...
static mrb_data_type ForeignObjectType_ZTSPFiP22sqlite3_rtree_geometryiPdPiE = {"Function_19*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP24sqlite3_rtree_query_infoE = {"Function_20*", drb_free_foreign_object_indirect};
...
struct drb_foreign_object_ZTS16sqlite3_snapshot {
    drb_foreign_object_kind kind;
    sqlite3_snapshot value;
};
static mrb_data_type ForeignObjectType_ZTS16sqlite3_snapshot = {"sqlite3_snapshot", drb_free_foreign_object_indirect};
static sqlite3_snapshot drb_ffi__ZTS16sqlite3_snapshot_FromRuby(mrb_state *state, mrb_value self) {
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Sqlite3_snapshot");
    drb_api->drb_typecheck_aggregate(state, self, klass, &ForeignObjectType_ZTS16sqlite3_snapshot);
    return ((struct drb_foreign_object_ZTS16sqlite3_snapshot *)DATA_PTR(self))->value;
}
static mrb_value drb_ffi__ZTS16sqlite3_snapshot_ToRuby(mrb_state *state, sqlite3_snapshot value) {
    struct drb_foreign_object_ZTS16sqlite3_snapshot *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTS16sqlite3_snapshot));
    ptr->value = value;
    ptr->kind = drb_foreign_object_kind_struct;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Sqlite3_snapshot");
    struct RData *rdata = drb_api->mrb_data_object_alloc(state, klass, ptr, &ForeignObjectType_ZTS16sqlite3_snapshot);
    return mrb_obj_value(rdata);
}
...
static mrb_data_type ForeignObjectType_ZTSPFiP7sqlite3PviPKPKcPP12sqlite3_vtabPPcE = {"Function_21*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_vtabP18sqlite3_index_infoE = {"Function_22*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_vtabE = {"Function_23*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_vtabPP19sqlite3_vtab_cursorE = {"Function_24*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP19sqlite3_vtab_cursorE = {"Function_25*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP19sqlite3_vtab_cursoriPKciPP13sqlite3_valueE = {"Function_26*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP19sqlite3_vtab_cursorP15sqlite3_contextiE = {"Function_27*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP19sqlite3_vtab_cursorPxE = {"Function_28*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_vtabiPP13sqlite3_valuePxE = {"Function_29*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_vtabiPKcPPFvP15sqlite3_contextiPP13sqlite3_valueEPPvE = {"Function_30*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_vtabPKcE = {"Function_31*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_vtabiE = {"Function_32*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiPKcE = {"Function_33*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsPKcP12sqlite3_fileiPiE = {"Function_34*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsPKciE = {"Function_35*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsPKciPiE = {"Function_36*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsPKciPcE = {"Function_37*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFPvP11sqlite3_vfsPKcE = {"Function_38*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFvP11sqlite3_vfsiPcE = {"Function_39*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFPFvvEP11sqlite3_vfsPvPKcE = {"Function_40*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFvP11sqlite3_vfsPvE = {"Function_41*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsiPcE = {"Function_42*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsiE = {"Function_43*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsPdE = {"Function_44*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsPxE = {"Function_45*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP11sqlite3_vfsPKcPFvvEE = {"Function_46*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFPFvvEP11sqlite3_vfsPKcE = {"Function_47*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFPKcP11sqlite3_vfsS0_E = {"Function_48*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_fileE = {"Function_49*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_filePvixE = {"Function_50*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_filePKvixE = {"Function_51*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_filexE = {"Function_52*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_fileiE = {"Function_53*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_filePxE = {"Function_54*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_filePiE = {"Function_55*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_fileiPvE = {"Function_56*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_fileiiiPPVvE = {"Function_57*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_fileiiiE = {"Function_58*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFvP12sqlite3_fileE = {"Function_59*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_filexiPPvE = {"Function_60*", drb_free_foreign_object_indirect};
...
static mrb_data_type ForeignObjectType_ZTSPFiP12sqlite3_filexPvE = {"Function_61*", drb_free_foreign_object_indirect};
static int (*drb_ffi__ZTSPFiP12sqlite3_filexPvE_FromRuby(mrb_state *state, mrb_value self))(sqlite3_file *, sqlite3_int64, void *) {
    if (mrb_nil_p(self))
        return 0;
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Function_61Pointer");
...
static mrb_value drb_ffi__ZTSPFvPPviE_New(mrb_state *mrb, mrb_value self) {
    struct drb_foreign_object_ZTSPFvPPviE *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTSPFvPPviE));
    ptr->kind = drb_foreign_object_kind_pointer;
    ptr->value = calloc(1, sizeof(void (void **, int)));
    ptr->should_free = 1;
    struct RClass *FFI = drb_api->mrb_module_get(mrb, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(mrb, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(mrb, module, "Function_17Pointer");
    struct RData *rdata = drb_api->mrb_data_object_alloc(mrb, klass, ptr, &ForeignObjectType_ZTSPFvPPviE);
    return mrb_obj_value(rdata);
}
static mrb_value drb_ffi__ZTSPFvPPviE_GetValue(mrb_state *mrb, mrb_value value) {
    drb_api->mrb_raise(mrb, drb_api->drb_getruntime_error(mrb), "Cannot access underlying value of the function pointer");
    return mrb_nil_value();
}
static mrb_value drb_ffi__ZTSPFvPPviE_IsNil(mrb_state *state, mrb_value self) {
    if (drb_ffi__ZTSPFvPPviE_FromRuby(state, self) == 0)
        return mrb_true_value();
    else
        return mrb_false_value();
}
static mrb_value drb_ffi__ZTSPFvPPviE_GetAt(mrb_state *mrb, mrb_value self) {
    drb_api->mrb_raise(mrb, drb_api->drb_getruntime_error(mrb), "Cannot access underlying value of the function pointer");
    return mrb_nil_value();
}
static mrb_value drb_ffi__ZTSPFvPPviE_SetAt(mrb_state *mrb, mrb_value self) {
    drb_api->mrb_raise(mrb, drb_api->drb_getruntime_error(mrb), "Cannot change underlying value of the function pointer");
    return mrb_nil_value();
}
...
static mrb_value drb_ffi__ZTSPP16sqlite3_snapshot_New(mrb_state *mrb, mrb_value self) {
    struct drb_foreign_object_ZTSPP16sqlite3_snapshot *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTSPP16sqlite3_snapshot));
    ptr->kind = drb_foreign_object_kind_pointer;
    ptr->value = calloc(1, sizeof(sqlite3_snapshot *));
    ptr->should_free = 1;
    struct RClass *FFI = drb_api->mrb_module_get(mrb, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(mrb, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(mrb, module, "Sqlite3_snapshotPointerPointer");
    struct RData *rdata = drb_api->mrb_data_object_alloc(mrb, klass, ptr, &ForeignObjectType_ZTSPP16sqlite3_snapshot);
    return mrb_obj_value(rdata);
}
static mrb_value drb_ffi__ZTSPP16sqlite3_snapshot_GetValue(mrb_state *mrb, mrb_value value) {
    return drb_ffi__ZTSP16sqlite3_snapshot_ToRuby(mrb, *drb_ffi__ZTSPP16sqlite3_snapshot_FromRuby(mrb, value));
}
static mrb_value drb_ffi__ZTSPP16sqlite3_snapshot_IsNil(mrb_state *state, mrb_value self) {
    if (drb_ffi__ZTSPP16sqlite3_snapshot_FromRuby(state, self) == 0)
        return mrb_true_value();
    else
        return mrb_false_value();
}
static mrb_value drb_ffi__ZTSPP16sqlite3_snapshot_GetAt(mrb_state *mrb, mrb_value self) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(mrb, "*", &args, &argc);
    int index = drb_ffi__ZTSi_FromRuby(mrb, args[0]);
    return drb_ffi__ZTSP16sqlite3_snapshot_ToRuby(mrb, drb_ffi__ZTSPP16sqlite3_snapshot_FromRuby(mrb, self)[index]);
}
static mrb_value drb_ffi__ZTSPP16sqlite3_snapshot_SetAt(mrb_state *mrb, mrb_value self) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(mrb, "*", &args, &argc);
    int index = drb_ffi__ZTSi_FromRuby(mrb, args[0]);
    sqlite3_snapshot *new_value = drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(mrb, args[1]);
    drb_ffi__ZTSPP16sqlite3_snapshot_FromRuby(mrb, self)[index] = new_value;
    return mrb_nil_value();
}
static mrb_value drb_ffi__ZTSP16sqlite3_snapshot_New(mrb_state *mrb, mrb_value self) {
    struct drb_foreign_object_ZTSP16sqlite3_snapshot *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTSP16sqlite3_snapshot));
    ptr->kind = drb_foreign_object_kind_pointer;
    ptr->value = calloc(1, sizeof(sqlite3_snapshot));
    ptr->should_free = 1;
    struct RClass *FFI = drb_api->mrb_module_get(mrb, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(mrb, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(mrb, module, "Sqlite3_snapshotPointer");
    struct RData *rdata = drb_api->mrb_data_object_alloc(mrb, klass, ptr, &ForeignObjectType_ZTSP16sqlite3_snapshot);
    return mrb_obj_value(rdata);
}
static mrb_value drb_ffi__ZTSP16sqlite3_snapshot_GetValue(mrb_state *mrb, mrb_value value) {
    return drb_ffi__ZTS16sqlite3_snapshot_ToRuby(mrb, *drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(mrb, value));
}
static mrb_value drb_ffi__ZTSP16sqlite3_snapshot_IsNil(mrb_state *state, mrb_value self) {
    if (drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(state, self) == 0)
        return mrb_true_value();
    else
        return mrb_false_value();
}
static mrb_value drb_ffi__ZTSP16sqlite3_snapshot_GetAt(mrb_state *mrb, mrb_value self) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(mrb, "*", &args, &argc);
    int index = drb_ffi__ZTSi_FromRuby(mrb, args[0]);
    return drb_ffi__ZTS16sqlite3_snapshot_ToRuby(mrb, drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(mrb, self)[index]);
}
static mrb_value drb_ffi__ZTSP16sqlite3_snapshot_SetAt(mrb_state *mrb, mrb_value self) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(mrb, "*", &args, &argc);
    int index = drb_ffi__ZTSi_FromRuby(mrb, args[0]);
    sqlite3_snapshot new_value = drb_ffi__ZTS16sqlite3_snapshot_FromRuby(mrb, args[1]);
    drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(mrb, self)[index] = new_value;
    return mrb_nil_value();
}
...
static mrb_value drb_ffi__ZTSPFiP12sqlite3_filexPvE_New(mrb_state *mrb, mrb_value self) {
    ...
    struct RClass *FFI = drb_api->mrb_module_get(mrb, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(mrb, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(mrb, module, "Function_61Pointer");
...
static mrb_value drb_ffi__ZTS16sqlite3_snapshot_New(mrb_state *state, mrb_value self) {
    struct drb_foreign_object_ZTS16sqlite3_snapshot *ptr = calloc(1, sizeof(struct drb_foreign_object_ZTS16sqlite3_snapshot *));
    struct RClass *FFI = drb_api->mrb_module_get(state, "FFI");
    struct RClass *module = drb_api->mrb_module_get_under(state, FFI, "LIBSQLITE3");
    struct RClass *klass = drb_api->mrb_class_get_under(state, module, "Sqlite3_snapshot");
...
static mrb_value drb_ffi__ZTS16sqlite3_snapshot_hidden_Get(mrb_state *state, mrb_value self) {
    drb_api->mrb_raise(state, drb_api->drb_getruntime_error(state), "Cannot get constant array field");
    return mrb_nil_value();
}
static mrb_value drb_ffi__ZTS16sqlite3_snapshot_hidden_Set(mrb_state *state, mrb_value self) {
...
static mrb_value drb_ffi_sqlite3_mutex_held_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_mutex_held': wrong number of arguments (%d for 1)", argc);
    sqlite3_mutex *_0 = drb_ffi__ZTSP13sqlite3_mutex_FromRuby(state, args[0]);
    int ret_val = sqlite3_mutex_held(_0);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
static mrb_value drb_ffi_sqlite3_mutex_notheld_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_mutex_notheld': wrong number of arguments (%d for 1)", argc);
    sqlite3_mutex *_0 = drb_ffi__ZTSP13sqlite3_mutex_FromRuby(state, args[0]);
    int ret_val = sqlite3_mutex_notheld(_0);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
...
static mrb_value drb_ffi_sqlite3_unlock_notify_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_unlock_notify': wrong number of arguments (%d for 3)", argc);
    sqlite3 *pBlocked_0 = drb_ffi__ZTSP7sqlite3_FromRuby(state, args[0]);
    void (*xNotify_1)(void **, int) = drb_ffi__ZTSPFvPPviE_FromRuby(state, args[1]);
    void *pNotifyArg_2 = drb_ffi__ZTSPv_FromRuby(state, args[2]);
    int ret_val = sqlite3_unlock_notify(pBlocked_0, xNotify_1, pNotifyArg_2);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
...
static mrb_value drb_ffi_sqlite3_stmt_scanstatus_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 4)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_stmt_scanstatus': wrong number of arguments (%d for 4)", argc);
    sqlite3_stmt *pStmt_0 = drb_ffi__ZTSP12sqlite3_stmt_FromRuby(state, args[0]);
    int idx_1 = drb_ffi__ZTSi_FromRuby(state, args[1]);
    int iScanStatusOp_2 = drb_ffi__ZTSi_FromRuby(state, args[2]);
    void *pOut_3 = drb_ffi__ZTSPv_FromRuby(state, args[3]);
    int ret_val = sqlite3_stmt_scanstatus(pStmt_0, idx_1, iScanStatusOp_2, pOut_3);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
static mrb_value drb_ffi_sqlite3_stmt_scanstatus_reset_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_stmt_scanstatus_reset': wrong number of arguments (%d for 1)", argc);
    sqlite3_stmt *_0 = drb_ffi__ZTSP12sqlite3_stmt_FromRuby(state, args[0]);
    sqlite3_stmt_scanstatus_reset(_0);
    return mrb_nil_value();
}
...
static mrb_value drb_ffi_sqlite3_snapshot_get_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_snapshot_get': wrong number of arguments (%d for 3)", argc);
    sqlite3 *db_0 = drb_ffi__ZTSP7sqlite3_FromRuby(state, args[0]);
    char *zSchema_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
    sqlite3_snapshot **ppSnapshot_2 = drb_ffi__ZTSPP16sqlite3_snapshot_FromRuby(state, args[2]);
    int ret_val = sqlite3_snapshot_get(db_0, zSchema_1, ppSnapshot_2);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
static mrb_value drb_ffi_sqlite3_snapshot_open_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 3)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_snapshot_open': wrong number of arguments (%d for 3)", argc);
    sqlite3 *db_0 = drb_ffi__ZTSP7sqlite3_FromRuby(state, args[0]);
    char *zSchema_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
    sqlite3_snapshot *pSnapshot_2 = drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(state, args[2]);
    int ret_val = sqlite3_snapshot_open(db_0, zSchema_1, pSnapshot_2);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
static mrb_value drb_ffi_sqlite3_snapshot_free_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 1)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_snapshot_free': wrong number of arguments (%d for 1)", argc);
    sqlite3_snapshot *_0 = drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(state, args[0]);
    sqlite3_snapshot_free(_0);
    return mrb_nil_value();
}
static mrb_value drb_ffi_sqlite3_snapshot_cmp_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_snapshot_cmp': wrong number of arguments (%d for 2)", argc);
    sqlite3_snapshot *p1_0 = drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(state, args[0]);
    sqlite3_snapshot *p2_1 = drb_ffi__ZTSP16sqlite3_snapshot_FromRuby(state, args[1]);
    int ret_val = sqlite3_snapshot_cmp(p1_0, p2_1);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
static mrb_value drb_ffi_sqlite3_snapshot_recover_Binding(mrb_state *state, mrb_value value) {
    mrb_value *args = 0;
    mrb_int argc = 0;
    drb_api->mrb_get_args(state, "*", &args, &argc);
    if (argc != 2)
        drb_api->mrb_raisef(state, drb_api->drb_getargument_error(state), "'sqlite3_snapshot_recover': wrong number of arguments (%d for 2)", argc);
    sqlite3 *db_0 = drb_ffi__ZTSP7sqlite3_FromRuby(state, args[0]);
    char *zDb_1 = drb_ffi__ZTSPc_FromRuby(state, args[1]);
    int ret_val = sqlite3_snapshot_recover(db_0, zDb_1);
    return drb_ffi__ZTSi_ToRuby(state, ret_val);
}
...
void drb_register_c_extensions_with_api(mrb_state *state, struct drb_api_t *api) {
    ...
    drb_api->mrb_define_module_function(state, module, "sqlite3_mutex_held", drb_ffi_sqlite3_mutex_held_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "sqlite3_mutex_notheld", drb_ffi_sqlite3_mutex_notheld_Binding, MRB_ARGS_REQ(1));
    ...
    drb_api->mrb_define_module_function(state, module, "sqlite3_unlock_notify", drb_ffi_sqlite3_unlock_notify_Binding, MRB_ARGS_REQ(3));
    ...
    drb_api->mrb_define_module_function(state, module, "sqlite3_stmt_scanstatus", drb_ffi_sqlite3_stmt_scanstatus_Binding, MRB_ARGS_REQ(4));
    drb_api->mrb_define_module_function(state, module, "sqlite3_stmt_scanstatus_reset", drb_ffi_sqlite3_stmt_scanstatus_reset_Binding, MRB_ARGS_REQ(1));
    ...
    drb_api->mrb_define_module_function(state, module, "sqlite3_snapshot_get", drb_ffi_sqlite3_snapshot_get_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "sqlite3_snapshot_open", drb_ffi_sqlite3_snapshot_open_Binding, MRB_ARGS_REQ(3));
    drb_api->mrb_define_module_function(state, module, "sqlite3_snapshot_free", drb_ffi_sqlite3_snapshot_free_Binding, MRB_ARGS_REQ(1));
    drb_api->mrb_define_module_function(state, module, "sqlite3_snapshot_cmp", drb_ffi_sqlite3_snapshot_cmp_Binding, MRB_ARGS_REQ(2));
    drb_api->mrb_define_module_function(state, module, "sqlite3_snapshot_recover", drb_ffi_sqlite3_snapshot_recover_Binding, MRB_ARGS_REQ(2));
    ...
    drb_api->mrb_define_class_method(state, Function_17PointerClass, "new", drb_ffi__ZTSPFvPPviE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_17PointerClass, "value", drb_ffi__ZTSPFvPPviE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_17PointerClass, "[]", drb_ffi__ZTSPFvPPviE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_17PointerClass, "[]=", drb_ffi__ZTSPFvPPviE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_17PointerClass, "nil?", drb_ffi__ZTSPFvPPviE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_18PointerClass = drb_api->mrb_define_class_under(state, module, "Function_18Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_18PointerClass, "new", drb_ffi__ZTSPFiPvP7sqlite3PKciE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_18PointerClass, "value", drb_ffi__ZTSPFiPvP7sqlite3PKciE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_18PointerClass, "[]", drb_ffi__ZTSPFiPvP7sqlite3PKciE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_18PointerClass, "[]=", drb_ffi__ZTSPFiPvP7sqlite3PKciE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_18PointerClass, "nil?", drb_ffi__ZTSPFiPvP7sqlite3PKciE_IsNil, MRB_ARGS_REQ(0));
    ...
    struct RClass *Sqlite3_snapshotPointerPointerClass = drb_api->mrb_define_class_under(state, module, "Sqlite3_snapshotPointerPointer", object_class);
    drb_api->mrb_define_class_method(state, Sqlite3_snapshotPointerPointerClass, "new", drb_ffi__ZTSPP16sqlite3_snapshot_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerPointerClass, "value", drb_ffi__ZTSPP16sqlite3_snapshot_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerPointerClass, "[]", drb_ffi__ZTSPP16sqlite3_snapshot_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerPointerClass, "[]=", drb_ffi__ZTSPP16sqlite3_snapshot_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerPointerClass, "nil?", drb_ffi__ZTSPP16sqlite3_snapshot_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Sqlite3_snapshotPointerClass = drb_api->mrb_define_class_under(state, module, "Sqlite3_snapshotPointer", object_class);
    drb_api->mrb_define_class_method(state, Sqlite3_snapshotPointerClass, "new", drb_ffi__ZTSP16sqlite3_snapshot_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerClass, "value", drb_ffi__ZTSP16sqlite3_snapshot_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerClass, "[]", drb_ffi__ZTSP16sqlite3_snapshot_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerClass, "[]=", drb_ffi__ZTSP16sqlite3_snapshot_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Sqlite3_snapshotPointerClass, "nil?", drb_ffi__ZTSP16sqlite3_snapshot_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_19PointerClass = drb_api->mrb_define_class_under(state, module, "Function_19Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_19PointerClass, "new", drb_ffi__ZTSPFiP22sqlite3_rtree_geometryiPdPiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_19PointerClass, "value", drb_ffi__ZTSPFiP22sqlite3_rtree_geometryiPdPiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_19PointerClass, "[]", drb_ffi__ZTSPFiP22sqlite3_rtree_geometryiPdPiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_19PointerClass, "[]=", drb_ffi__ZTSPFiP22sqlite3_rtree_geometryiPdPiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_19PointerClass, "nil?", drb_ffi__ZTSPFiP22sqlite3_rtree_geometryiPdPiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_20PointerClass = drb_api->mrb_define_class_under(state, module, "Function_20Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_20PointerClass, "new", drb_ffi__ZTSPFiP24sqlite3_rtree_query_infoE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_20PointerClass, "value", drb_ffi__ZTSPFiP24sqlite3_rtree_query_infoE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_20PointerClass, "[]", drb_ffi__ZTSPFiP24sqlite3_rtree_query_infoE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_20PointerClass, "[]=", drb_ffi__ZTSPFiP24sqlite3_rtree_query_infoE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_20PointerClass, "nil?", drb_ffi__ZTSPFiP24sqlite3_rtree_query_infoE_IsNil, MRB_ARGS_REQ(0));
    ...
    drb_api->mrb_define_class_method(state, Function_21PointerClass, "new", drb_ffi__ZTSPFiP7sqlite3PviPKPKcPP12sqlite3_vtabPPcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_21PointerClass, "value", drb_ffi__ZTSPFiP7sqlite3PviPKPKcPP12sqlite3_vtabPPcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_21PointerClass, "[]", drb_ffi__ZTSPFiP7sqlite3PviPKPKcPP12sqlite3_vtabPPcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_21PointerClass, "[]=", drb_ffi__ZTSPFiP7sqlite3PviPKPKcPP12sqlite3_vtabPPcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_21PointerClass, "nil?", drb_ffi__ZTSPFiP7sqlite3PviPKPKcPP12sqlite3_vtabPPcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_22PointerClass = drb_api->mrb_define_class_under(state, module, "Function_22Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_22PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_vtabP18sqlite3_index_infoE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_22PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_vtabP18sqlite3_index_infoE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_22PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_vtabP18sqlite3_index_infoE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_22PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_vtabP18sqlite3_index_infoE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_22PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_vtabP18sqlite3_index_infoE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_23PointerClass = drb_api->mrb_define_class_under(state, module, "Function_23Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_23PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_vtabE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_23PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_vtabE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_23PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_vtabE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_23PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_vtabE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_23PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_vtabE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_24PointerClass = drb_api->mrb_define_class_under(state, module, "Function_24Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_24PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_vtabPP19sqlite3_vtab_cursorE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_24PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_vtabPP19sqlite3_vtab_cursorE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_24PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_vtabPP19sqlite3_vtab_cursorE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_24PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_vtabPP19sqlite3_vtab_cursorE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_24PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_vtabPP19sqlite3_vtab_cursorE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_25PointerClass = drb_api->mrb_define_class_under(state, module, "Function_25Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_25PointerClass, "new", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_25PointerClass, "value", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_25PointerClass, "[]", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_25PointerClass, "[]=", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_25PointerClass, "nil?", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_26PointerClass = drb_api->mrb_define_class_under(state, module, "Function_26Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_26PointerClass, "new", drb_ffi__ZTSPFiP19sqlite3_vtab_cursoriPKciPP13sqlite3_valueE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_26PointerClass, "value", drb_ffi__ZTSPFiP19sqlite3_vtab_cursoriPKciPP13sqlite3_valueE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_26PointerClass, "[]", drb_ffi__ZTSPFiP19sqlite3_vtab_cursoriPKciPP13sqlite3_valueE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_26PointerClass, "[]=", drb_ffi__ZTSPFiP19sqlite3_vtab_cursoriPKciPP13sqlite3_valueE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_26PointerClass, "nil?", drb_ffi__ZTSPFiP19sqlite3_vtab_cursoriPKciPP13sqlite3_valueE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_27PointerClass = drb_api->mrb_define_class_under(state, module, "Function_27Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_27PointerClass, "new", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorP15sqlite3_contextiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_27PointerClass, "value", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorP15sqlite3_contextiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_27PointerClass, "[]", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorP15sqlite3_contextiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_27PointerClass, "[]=", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorP15sqlite3_contextiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_27PointerClass, "nil?", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorP15sqlite3_contextiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_28PointerClass = drb_api->mrb_define_class_under(state, module, "Function_28Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_28PointerClass, "new", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorPxE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_28PointerClass, "value", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorPxE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_28PointerClass, "[]", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorPxE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_28PointerClass, "[]=", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorPxE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_28PointerClass, "nil?", drb_ffi__ZTSPFiP19sqlite3_vtab_cursorPxE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_29PointerClass = drb_api->mrb_define_class_under(state, module, "Function_29Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_29PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_vtabiPP13sqlite3_valuePxE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_29PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_vtabiPP13sqlite3_valuePxE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_29PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_vtabiPP13sqlite3_valuePxE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_29PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_vtabiPP13sqlite3_valuePxE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_29PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_vtabiPP13sqlite3_valuePxE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_30PointerClass = drb_api->mrb_define_class_under(state, module, "Function_30Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_30PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_vtabiPKcPPFvP15sqlite3_contextiPP13sqlite3_valueEPPvE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_30PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_vtabiPKcPPFvP15sqlite3_contextiPP13sqlite3_valueEPPvE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_30PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_vtabiPKcPPFvP15sqlite3_contextiPP13sqlite3_valueEPPvE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_30PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_vtabiPKcPPFvP15sqlite3_contextiPP13sqlite3_valueEPPvE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_30PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_vtabiPKcPPFvP15sqlite3_contextiPP13sqlite3_valueEPPvE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_31PointerClass = drb_api->mrb_define_class_under(state, module, "Function_31Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_31PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_vtabPKcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_31PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_vtabPKcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_31PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_vtabPKcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_31PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_vtabPKcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_31PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_vtabPKcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_32PointerClass = drb_api->mrb_define_class_under(state, module, "Function_32Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_32PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_vtabiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_32PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_vtabiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_32PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_vtabiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_32PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_vtabiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_32PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_vtabiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_33PointerClass = drb_api->mrb_define_class_under(state, module, "Function_33Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_33PointerClass, "new", drb_ffi__ZTSPFiPKcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_33PointerClass, "value", drb_ffi__ZTSPFiPKcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_33PointerClass, "[]", drb_ffi__ZTSPFiPKcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_33PointerClass, "[]=", drb_ffi__ZTSPFiPKcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_33PointerClass, "nil?", drb_ffi__ZTSPFiPKcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_34PointerClass = drb_api->mrb_define_class_under(state, module, "Function_34Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_34PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsPKcP12sqlite3_fileiPiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_34PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsPKcP12sqlite3_fileiPiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_34PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsPKcP12sqlite3_fileiPiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_34PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsPKcP12sqlite3_fileiPiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_34PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsPKcP12sqlite3_fileiPiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_35PointerClass = drb_api->mrb_define_class_under(state, module, "Function_35Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_35PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsPKciE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_35PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsPKciE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_35PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsPKciE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_35PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsPKciE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_35PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsPKciE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_36PointerClass = drb_api->mrb_define_class_under(state, module, "Function_36Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_36PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_36PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_36PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_36PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_36PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_37PointerClass = drb_api->mrb_define_class_under(state, module, "Function_37Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_37PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_37PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_37PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_37PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_37PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsPKciPcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_38PointerClass = drb_api->mrb_define_class_under(state, module, "Function_38Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_38PointerClass, "new", drb_ffi__ZTSPFPvP11sqlite3_vfsPKcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_38PointerClass, "value", drb_ffi__ZTSPFPvP11sqlite3_vfsPKcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_38PointerClass, "[]", drb_ffi__ZTSPFPvP11sqlite3_vfsPKcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_38PointerClass, "[]=", drb_ffi__ZTSPFPvP11sqlite3_vfsPKcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_38PointerClass, "nil?", drb_ffi__ZTSPFPvP11sqlite3_vfsPKcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_39PointerClass = drb_api->mrb_define_class_under(state, module, "Function_39Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_39PointerClass, "new", drb_ffi__ZTSPFvP11sqlite3_vfsiPcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_39PointerClass, "value", drb_ffi__ZTSPFvP11sqlite3_vfsiPcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_39PointerClass, "[]", drb_ffi__ZTSPFvP11sqlite3_vfsiPcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_39PointerClass, "[]=", drb_ffi__ZTSPFvP11sqlite3_vfsiPcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_39PointerClass, "nil?", drb_ffi__ZTSPFvP11sqlite3_vfsiPcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_40PointerClass = drb_api->mrb_define_class_under(state, module, "Function_40Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_40PointerClass, "new", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPvPKcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_40PointerClass, "value", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPvPKcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_40PointerClass, "[]", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPvPKcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_40PointerClass, "[]=", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPvPKcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_40PointerClass, "nil?", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPvPKcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_41PointerClass = drb_api->mrb_define_class_under(state, module, "Function_41Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_41PointerClass, "new", drb_ffi__ZTSPFvP11sqlite3_vfsPvE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_41PointerClass, "value", drb_ffi__ZTSPFvP11sqlite3_vfsPvE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_41PointerClass, "[]", drb_ffi__ZTSPFvP11sqlite3_vfsPvE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_41PointerClass, "[]=", drb_ffi__ZTSPFvP11sqlite3_vfsPvE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_41PointerClass, "nil?", drb_ffi__ZTSPFvP11sqlite3_vfsPvE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_42PointerClass = drb_api->mrb_define_class_under(state, module, "Function_42Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_42PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsiPcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_42PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsiPcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_42PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsiPcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_42PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsiPcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_42PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsiPcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_43PointerClass = drb_api->mrb_define_class_under(state, module, "Function_43Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_43PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_43PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_43PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_43PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_43PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_44PointerClass = drb_api->mrb_define_class_under(state, module, "Function_44Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_44PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsPdE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_44PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsPdE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_44PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsPdE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_44PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsPdE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_44PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsPdE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_45PointerClass = drb_api->mrb_define_class_under(state, module, "Function_45Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_45PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsPxE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_45PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsPxE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_45PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsPxE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_45PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsPxE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_45PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsPxE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_46PointerClass = drb_api->mrb_define_class_under(state, module, "Function_46Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_46PointerClass, "new", drb_ffi__ZTSPFiP11sqlite3_vfsPKcPFvvEE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_46PointerClass, "value", drb_ffi__ZTSPFiP11sqlite3_vfsPKcPFvvEE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_46PointerClass, "[]", drb_ffi__ZTSPFiP11sqlite3_vfsPKcPFvvEE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_46PointerClass, "[]=", drb_ffi__ZTSPFiP11sqlite3_vfsPKcPFvvEE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_46PointerClass, "nil?", drb_ffi__ZTSPFiP11sqlite3_vfsPKcPFvvEE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_47PointerClass = drb_api->mrb_define_class_under(state, module, "Function_47Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_47PointerClass, "new", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPKcE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_47PointerClass, "value", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPKcE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_47PointerClass, "[]", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPKcE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_47PointerClass, "[]=", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPKcE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_47PointerClass, "nil?", drb_ffi__ZTSPFPFvvEP11sqlite3_vfsPKcE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_48PointerClass = drb_api->mrb_define_class_under(state, module, "Function_48Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_48PointerClass, "new", drb_ffi__ZTSPFPKcP11sqlite3_vfsS0_E_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_48PointerClass, "value", drb_ffi__ZTSPFPKcP11sqlite3_vfsS0_E_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_48PointerClass, "[]", drb_ffi__ZTSPFPKcP11sqlite3_vfsS0_E_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_48PointerClass, "[]=", drb_ffi__ZTSPFPKcP11sqlite3_vfsS0_E_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_48PointerClass, "nil?", drb_ffi__ZTSPFPKcP11sqlite3_vfsS0_E_IsNil, MRB_ARGS_REQ(0));
    ...
    drb_api->mrb_define_class_method(state, Function_49PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_fileE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_49PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_fileE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_49PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_fileE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_49PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_fileE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_49PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_fileE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_50PointerClass = drb_api->mrb_define_class_under(state, module, "Function_50Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_50PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_filePvixE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_50PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_filePvixE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_50PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_filePvixE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_50PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_filePvixE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_50PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_filePvixE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_51PointerClass = drb_api->mrb_define_class_under(state, module, "Function_51Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_51PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_filePKvixE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_51PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_filePKvixE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_51PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_filePKvixE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_51PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_filePKvixE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_51PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_filePKvixE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_52PointerClass = drb_api->mrb_define_class_under(state, module, "Function_52Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_52PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_filexE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_52PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_filexE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_52PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_filexE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_52PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_filexE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_52PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_filexE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_53PointerClass = drb_api->mrb_define_class_under(state, module, "Function_53Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_53PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_fileiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_53PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_fileiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_53PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_fileiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_53PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_fileiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_53PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_fileiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_54PointerClass = drb_api->mrb_define_class_under(state, module, "Function_54Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_54PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_filePxE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_54PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_filePxE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_54PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_filePxE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_54PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_filePxE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_54PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_filePxE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_55PointerClass = drb_api->mrb_define_class_under(state, module, "Function_55Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_55PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_filePiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_55PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_filePiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_55PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_filePiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_55PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_filePiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_55PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_filePiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_56PointerClass = drb_api->mrb_define_class_under(state, module, "Function_56Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_56PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_fileiPvE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_56PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_fileiPvE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_56PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_fileiPvE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_56PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_fileiPvE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_56PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_fileiPvE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_57PointerClass = drb_api->mrb_define_class_under(state, module, "Function_57Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_57PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_fileiiiPPVvE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_57PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_fileiiiPPVvE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_57PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_fileiiiPPVvE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_57PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_fileiiiPPVvE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_57PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_fileiiiPPVvE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_58PointerClass = drb_api->mrb_define_class_under(state, module, "Function_58Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_58PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_fileiiiE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_58PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_fileiiiE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_58PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_fileiiiE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_58PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_fileiiiE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_58PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_fileiiiE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_59PointerClass = drb_api->mrb_define_class_under(state, module, "Function_59Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_59PointerClass, "new", drb_ffi__ZTSPFvP12sqlite3_fileE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_59PointerClass, "value", drb_ffi__ZTSPFvP12sqlite3_fileE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_59PointerClass, "[]", drb_ffi__ZTSPFvP12sqlite3_fileE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_59PointerClass, "[]=", drb_ffi__ZTSPFvP12sqlite3_fileE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_59PointerClass, "nil?", drb_ffi__ZTSPFvP12sqlite3_fileE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_60PointerClass = drb_api->mrb_define_class_under(state, module, "Function_60Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_60PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_filexiPPvE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_60PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_filexiPPvE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_60PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_filexiPPvE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_60PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_filexiPPvE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_60PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_filexiPPvE_IsNil, MRB_ARGS_REQ(0));
    struct RClass *Function_61PointerClass = drb_api->mrb_define_class_under(state, module, "Function_61Pointer", object_class);
    drb_api->mrb_define_class_method(state, Function_61PointerClass, "new", drb_ffi__ZTSPFiP12sqlite3_filexPvE_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_61PointerClass, "value", drb_ffi__ZTSPFiP12sqlite3_filexPvE_GetValue, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Function_61PointerClass, "[]", drb_ffi__ZTSPFiP12sqlite3_filexPvE_GetAt, MRB_ARGS_REQ(1));
    drb_api->mrb_define_method(state, Function_61PointerClass, "[]=", drb_ffi__ZTSPFiP12sqlite3_filexPvE_SetAt, MRB_ARGS_REQ(2));
    drb_api->mrb_define_method(state, Function_61PointerClass, "nil?", drb_ffi__ZTSPFiP12sqlite3_filexPvE_IsNil, MRB_ARGS_REQ(0));
    ...
    struct RClass *Sqlite3_snapshotClass = drb_api->mrb_define_class_under(state, module, "Sqlite3_snapshot", object_class);
    drb_api->mrb_define_class_method(state, Sqlite3_snapshotClass, "new", drb_ffi__ZTS16sqlite3_snapshot_New, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Sqlite3_snapshotClass, "hidden", drb_ffi__ZTS16sqlite3_snapshot_hidden_Get, MRB_ARGS_REQ(0));
    drb_api->mrb_define_method(state, Sqlite3_snapshotClass, "hidden=", drb_ffi__ZTS16sqlite3_snapshot_hidden_Set, MRB_ARGS_REQ(1));
